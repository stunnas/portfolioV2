...
import { useScrollContext } from '@/hooks/use-scroll';
...
export const MacbookScroll = ({
	...
	}, [scaleX, scaleY, translate, rotate, textTransform, textOpacity]);

	return (
		<div
			ref={scrollContainerRef}
			className='min-h-[100vh] flex flex-col items-center py-0 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100 sm:scale-50'
		>
			<motion.h2
				style={{
