			...
			<div className='relative flex h-full items-center overflow-hidden rounded-lg'>
				<div className='absolute'>
					...
					>
						<p
							ref={firstText}
							className='m-0 mr-3 text-6xl font-medium text-gray-700 dark:text-white md:text-6xl lg:text-9xl'
						>
							{text}
						</p>
						<p
							ref={secondText}
							className='m-0 text-6xl font-medium text-gray-700 dark:text-white md:text-6xl lg:text-9xl'
						>
							{text}
						</p>
					</div>
